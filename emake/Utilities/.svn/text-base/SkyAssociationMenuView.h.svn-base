 ...
 *
 */
-(BOOL)assciationMenuView:(SkyAssociationMenuView*)asView saveSelectedClass:(NSInteger)idx_1 class2:(NSInteger)idx_2 class3:(NSInteger)idx_3;
 ...
 *
 */
-(void)assciationMenuView:(SkyAssociationMenuView*)asView resetSelectedClass:(NSInteger)idx_1 class2:(NSInteger)idx_2 class3:(NSInteger)idx_3;

-(void)assciationDismissMenuView:(SkyAssociationMenuView*)asView ;
@end
...
@property (nonatomic) NSMutableArray *sels;
