...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        goodsImageView.layer.borderColor = SepratorLineColor.CGColor;
        goodsImageView.layer.borderWidth = 1;
        [self addSubview:goodsImageView];
        goodsImageView.contentMode = UIViewContentModeScaleAspectFit;
        [goodsImageView PSSetSize:WidthRate(70) Height:HeightRate(70)];
        ...
        [companyLable PSSetLeft:WidthRate(92)];
        ...
        orderMoneyLable.textColor = ColorWithHexString(StandardBlueColor);
        orderMoneyLable.font = [UIFont systemFontOfSize:AdaptFont(18)];
        [self addSubview:orderMoneyLable];
        [orderMoneyLable PSSetBottomAtItem:companyLable Length:HeightRate(5)];
        [orderMoneyLable PSSetLeft:WidthRate(92)];
        ...
        orderNumberLable.font = [UIFont systemFontOfSize:AdaptFont(11)];
        [self addSubview:orderNumberLable];
        [orderNumberLable PSSetLeft:WidthRate(92)];
...
//        [orderNumberLable PSSetBottom:HeightRate(5)];
        ...
        [customSeviceButton PSSetTop:HeightRate(15)];
        ...
        [line PSSetBottomAtItem:goodsImageView Length:HeightRate(10)];
        [line PSSetBottom:0];
