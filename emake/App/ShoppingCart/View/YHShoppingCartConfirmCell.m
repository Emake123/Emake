...
- (instancetype)init{
    ...
    if (self) {
        ...
        [lable PSSetBottomAtItem:weight Length:HeightRate(10)];
        [lable PSSetLeft:0];
...
- (void)setData:(YHShoppingCartModel *)model{
    ...
    self.smallPrice.text = [NSString stringWithFormat:@"¥%@",[Tools getHaveNum:model.ProductGroupPrice.doubleValue*model.GoodsNumber.integerValue]];
