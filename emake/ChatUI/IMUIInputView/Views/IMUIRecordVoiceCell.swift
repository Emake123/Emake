...
//            print("121111111111111=seconds=%@,",seconds,);
//if(seco)
          self.timeLable.text = "\(String(format: "%02d", seconds / 60)):\(String(format: "%02d", seconds % 60))"
//            print("121111111111111=seconds=%@,%@",seconds,self.timeLable.text);
